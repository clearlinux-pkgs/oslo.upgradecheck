...
Version  : 0.4.0
Release  : 11
URL      : https://files.pythonhosted.org/packages/e8/d7/9b3221d8a2ddbd65cd7883f9776373e6cd8a5a37dcf2792e26450d29996b/oslo.upgradecheck-0.4.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/e8/d7/9b3221d8a2ddbd65cd7883f9776373e6cd8a5a37dcf2792e26450d29996b/oslo.upgradecheck-0.4.0.tar.gz
...
%prep
%setup -q -n oslo.upgradecheck-0.4.0
cd %{_builddir}/oslo.upgradecheck-0.4.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581436431
...
cp %{_builddir}/oslo.upgradecheck-0.4.0/LICENSE %{buildroot}/usr/share/package-licenses/oslo.upgradecheck/294b43b2cec9919063be1a3b49e8722648424779
